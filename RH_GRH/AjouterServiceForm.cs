...
namespace RH_GRH
{
    public partial class AjouterServiceForm : Form
    {
        ...
        private void RemplacerComboEntrepriseParRecherche()
        {
            ...
            var labelNomService = parent.Controls.OfType<Label>()
                .FirstOrDefault(l => l.Text.Contains("service"));
            var textBoxNomService = parent.Controls.OfType<Guna2TextBox>()
                .FirstOrDefault(t => t.Name == "textBoxNomService");
            ...
            if (labelNomService != null)
                labelNomService.Location = new Point(30, 237);
            if (textBoxNomService != null)
                textBoxNomService.Location = new Point(30, 262);
        ...
        private void buttonAjouter_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ServiceClass.EnregistrerService(nomService, idEntreprise);

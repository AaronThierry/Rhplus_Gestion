                    ...
                    using (var reader = cmd.ExecuteReader())
                    {
                        if (reader.Read())
                        {
                            employe = new Employe(
                                ...
                                banque: reader.IsDBNull(reader.GetOrdinal("banque")) ? string.Empty : reader.GetString("banque"),
                                numeroBancaire: reader.IsDBNull(reader.GetOrdinal("numeroBancaire")) ? string.Empty : reader.GetString("numeroBancaire"),

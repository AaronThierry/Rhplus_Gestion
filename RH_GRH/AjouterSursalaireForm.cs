...
namespace RH_GRH
{
    public partial class AjouterSursalaireForm : Form
    {
        private Dbconnect connect = new Dbconnect();
        private DataTable tousLesEmployes;
        private DataTable employesFiltres;

        public AjouterSursalaireForm()
        {
            InitializeComponent();
        ...
        private void buttonEnregistrer_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SursalaireRepository.Ajouter(sursalaire);

                CustomMessageBox.Show("Sursalaire ajouté avec succès!", "Succès",
